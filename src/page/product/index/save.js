...
import CategorySelector from 'page/product/index/category-selector.js';
import FileUploader from 'util/file-uploader/index.js';
import RichEditor from 'util/rich-editor/index.js';
...
class ProductSave extends React.Component {
  ...
  render() {
    return (
      <div id="page-wrapper">
        <Title title={this.state.id ? '编辑商品' : '添加商品'}/>
